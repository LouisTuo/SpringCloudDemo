...
public class CreateSecrteKey {
    ...
    public static void test() throws NoSuchAlgorithmException {
        ...
        String publicHexStr = Hex.encodeHexString(publicKey.getEncoded());
        System.out.println("公钥：\n"+ publicHexStr);
        System.out.println(publicHexStr.length());
        String privateStr = Base64.getEncoder().encodeToString(privateKey.getEncoded());
        String privateHexStr = Hex.encodeHexString(privateKey.getEncoded());
        System.out.println("私钥：\n"+ privateHexStr);
        System.out.println(privateHexStr.length());
    }
}
